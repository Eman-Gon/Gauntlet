...
class Settings(BaseSettings):
    ...
    # GMI can be used as the cheap OpenAI-compatible judge/provider for the
    # hackathon path. These are intentionally optional: the deterministic probe
    # battery and local memory run without external setup.
    GMI_API_KEY: str = ""
    GMI_BASE_URL: str = ""
